...
public class ModBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        // Resin bricks
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.RESIN_BRICKS.get(),
        ...
        tag(PALE_OAK_LOGS).add(ModBlocks.PALE_OAK_LOG.get(), ModBlocks.STRIPPED_PALE_OAK_LOG.get(),
